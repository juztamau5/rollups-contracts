...
- `ComplexVouchers`: Allows DApp developers to generate more complex vouchers, with extra restrictions. See [RFP #003](https://governance.cartesi.io/t/rfp-003-beginner-solidity-complex-vouchers/90).
